...
public class OnOffEdgeTransDirMulti extends
  ...
  MultinomialBayesianEstimator freeMotionTransEstimator =
      new MultinomialBayesianEstimator(
  ...
  public OnOffEdgeTransDirMulti clone() {
    ...
    transDist.freeMotionTransEstimator =
        (MultinomialBayesianEstimator) this.freeMotionTransEstimator
            .clone();
    transDist.setEdgeMotionTransPrior(this
        .getEdgeMotionTransPrior().clone());
    transDist.setFreeMotionTransPrior(this
        .getFreeMotionTransPrior().clone());
  ...
  public boolean equals(Object obj) {
    ...
    if (getEdgeMotionTransPrior() == null) {
      if (other.getEdgeMotionTransPrior() != null) {
        ...
        getEdgeMotionTransPrior().getParameters(), other
            .getEdgeMotionTransPrior().getParameters())) {
      return false;
    }
    if (getEdgeMotionTransProbPrior() == null) {
      if (other.getEdgeMotionTransProbPrior() != null) {
        ...
        .vectorEquals(getEdgeMotionTransProbPrior()
            .getParameters(), other
            .getEdgeMotionTransProbPrior().getParameters())) {
      return false;
    }
    if (getFreeMotionTransPrior() == null) {
      if (other.getFreeMotionTransPrior() != null) {
        ...
        getFreeMotionTransPrior().getParameters(), other
            .getFreeMotionTransPrior().getParameters())) {
      return false;
    }
    if (getFreeMotionTransProbPrior() == null) {
      if (other.getFreeMotionTransProbPrior() != null) {
        ...
        .vectorEquals(getFreeMotionTransProbPrior()
            .getParameters(), other
            .getFreeMotionTransProbPrior().getParameters())) {
      return false;
    }
  ...
  public double
    ...
    if (from.isEmptyEdge()) {
      ...
      return getEdgeMotionTransPrior()
          .getProbabilityFunction().evaluate(
              getTransitionType(from, to));
    }
  }
  ...
  public int hashCode() {
    ...
    result =
        prime
            * result
            + ((getEdgeMotionTransProbPrior() == null)
                ? 0
                : StatisticsUtil
    ...
    result =
        prime
            * result
            + ((getFreeMotionTransProbPrior() == null)
                ? 0
                : StatisticsUtil
  ...
  public InferredEdge sample(Random rng,
    List<InferredEdge> transferEdges,
    ...
    if (currentEdge == InferredEdge.getEmptyEdge()) {
       ...
       */
      final Vector sample =
          transferEdges.contains(InferredEdge
              .getEmptyEdge()) ? this
  ...
  public void update(InferredEdge from, InferredEdge to) {
    ...
    if (from.isEmptyEdge()) {
      ...
      freeMotionTransPrior
          .setParameters(freeMotionTransProbPrior.getMean());
    } else {
      edgeMotionTransEstimator.update(
          getEdgeMotionTransProbPrior(), transType);
      edgeMotionTransPrior
          .setParameters(edgeMotionTransProbPrior.getMean());
    }
  }
