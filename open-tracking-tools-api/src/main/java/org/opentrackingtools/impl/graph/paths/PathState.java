...
public class PathState extends AbstractPathState implements
  ...
  public int compareTo(PathState o) {
    ...
    comparator.append(this.globalState, o.globalState);
    comparator.append(this.rawState, o.rawState);
  ...
  public static PathState getPathState(
