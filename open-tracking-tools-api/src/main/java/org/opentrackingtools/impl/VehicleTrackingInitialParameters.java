...
public class VehicleTrackingInitialParameters extends
    AbstractCloneableSerializable implements Comparable<VehicleTrackingInitialParameters> {
  ...
  public VehicleTrackingInitialParameters(Vector obsCov,
  ...
  @Override
  public VehicleTrackingInitialParameters clone() {
    final VehicleTrackingInitialParameters clone =
        (VehicleTrackingInitialParameters) super.clone();
    // TODO
    return clone;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final VehicleTrackingInitialParameters other =
        (VehicleTrackingInitialParameters) obj;
  ...
  @Override
  public int compareTo(VehicleTrackingInitialParameters o) {
