...
public class Observation implements
    Comparable<Observation>, Serializable {
   ...
   */
  private static Map<String, Observation> vehiclesToRecords =
  ...
  public String toString() {
    return "Observation [vehicleId=" + vehicleId
        + ", timestamp=" + timestamp + ", obsCoords="
        + obsCoords + ", obsPoint=" + obsPoint
  ...
  public static Observation createObservation(
    ObservationData obsData) throws TimeOrderException {
  ...
  public static synchronized Observation createObservation(
    ...
    final Observation obs =
        new Observation(vehicleId, time, obsCoords,
            obsPoint, velocity, heading, accuracy, prevObs,
            recordNumber);
  ...
  public static Map<String, Observation>
