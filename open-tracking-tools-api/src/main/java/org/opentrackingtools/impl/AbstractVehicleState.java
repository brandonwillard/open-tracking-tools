 ...
 * 
 */
public class AbstractVehicleState implements
    ComputableDistribution<GpsObservation>,
    Comparable<AbstractVehicleState> {

  public static class PDF extends AbstractVehicleState implements
      ProbabilityFunction<GpsObservation> {

    private static final long serialVersionUID =
        879217079360170446L;

    public PDF(AbstractVehicleState state) {
      super(state);
    }
    ...
    @Override
    public AbstractVehicleState.PDF getProbabilityFunction() {
      return this;
    }
   ...
   */
  protected final AbstractRoadTrackingEstimator movementFilter;
  ...
  protected final GpsObservation observation;
  protected AbstractVehicleState parentState = null;

  protected final InferenceGraph graph;
  ...
  protected AbstractVehicleState(AbstractVehicleState other) {
  ...
  @Override
  public AbstractVehicleState clone() {
    return new AbstractVehicleState(this);
  }

  @Override
  public int compareTo(AbstractVehicleState arg0) {
  ...
  public boolean equals(Object obj) {
    ...
    final AbstractVehicleState other = (AbstractVehicleState) obj;
    if (parentState == null) {
  ...
  public AbstractVehicleState getParentState() {
    return parentState;
  }

  @Override
  public AbstractVehicleState.PDF getProbabilityFunction() {
    return new AbstractVehicleState.PDF(this);
  }
  ...
  public void setParentState(AbstractVehicleState parentState) {
    this.parentState = parentState;
  }
  ...
  protected static int oneStateCompareTo(AbstractVehicleState t,
    AbstractVehicleState o) {
    if (t == o)
      return 0;
  ...
  protected static boolean oneStateEquals(Object thisObj,
    ...
    final AbstractVehicleState thisState = (AbstractVehicleState) thisObj;
    final AbstractVehicleState other = (AbstractVehicleState) obj;
  ...
  protected static int oneStateHashCode(AbstractVehicleState state) {
    final int prime = 31;
    int result = 1;
    result =
        prime
