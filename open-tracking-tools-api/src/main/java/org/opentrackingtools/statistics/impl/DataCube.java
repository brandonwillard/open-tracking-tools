package org.opentrackingtools.statistics.impl;
...
public class DataCube implements Serializable {
  ...
  public HashMap<Integer, Double>
      filterAndGroup(
        HashMap<String, Integer> filterAttributes,
        String group) {
          ...
          if (filterSet == null)
            filterSet =
                attributeMap.get(attribute)
                    .get(filterAttributes.get(attribute))
                    .keySet();
          else
    ...
    if (attributeMap.containsKey(group)) {
      for (final Integer g : attributeMap.get(group)
          .keySet()) {
  ...
  public void store(Double d,
    ...
    for (final String attribute : attributes.keySet()) {
      ...
      final Integer value = Integer.parseInt(attributes.get(attribute));
