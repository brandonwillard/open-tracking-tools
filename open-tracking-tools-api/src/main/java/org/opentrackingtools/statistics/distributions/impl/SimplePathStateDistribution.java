...
public class SimplePathStateDistribution extends AbstractPathState implements PathStateDistribution {
  ...
  protected SimplePathStateDistribution(InferredPath path,
  ...
  @Override
  public SimplePathStateDistribution clone() {
    final SimplePathStateDistribution clone =
        (SimplePathStateDistribution) super.clone();
  ...
  public int compareTo(PathState o) {
    ...
    if (o instanceof SimplePathStateDistribution)
      comparator
          .append(this.rawStateBelief, 
              ((SimplePathStateDistribution) o).rawStateBelief);
  ...
  public boolean equals(Object obj) {
    ...
    final SimplePathStateDistribution other = (SimplePathStateDistribution) obj;
  ...
  public double logLikelihood(Vector obs,
    ...
    return SimplePathStateDistribution.logLikelihood(obs,
  ...
  public double priorPredictiveLogLikelihood(Vector obs,
    ...
    final double result =
        SimplePathStateDistribution.logLikelihood(obs, Q, this);
    return result;
  }
  ...
  public PathStateDistribution getTruncatedPathStateBelief() {
    ...
    return new SimplePathStateDistribution(newPath, this.rawStateBelief);
  }
  ...
  public static SimplePathStateDistribution getPathStateBelief(
    ...
    return new SimplePathStateDistribution(path, adjState);
  }
