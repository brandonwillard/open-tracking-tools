...
public abstract class AbstractVehicleStateUpdater
    implements
  ...
  protected final AbstractRoadTrackingEstimator roadFilterGenerator; 

  public AbstractVehicleStateUpdater(
      GpsObservation obs,
      ...
      roadFilterGenerator = 
          (AbstractRoadTrackingEstimator) ctor.newInstance(
  ...
  @Override
  public AbstractVehicleStateUpdater clone() {
    try {
      final AbstractVehicleStateUpdater clone =
          (AbstractVehicleStateUpdater) super.clone();
      clone.seed = seed;
  ...
  public DataDistribution<VehicleState>
    ...
    for (int i = 0; i < numParticles; i++) {
      final AbstractRoadTrackingEstimator tmpTrackingFilter =
      ...
      if (!initialEdges.isEmpty()) {
        for (final InferredEdge edge: initialEdges) {
           ...
           */
          final AbstractRoadTrackingEstimator trackingFilter =
              this.createRoadTrackingFilter();
          ...
          final PathStateDistribution pathStateDistribution =
          ...
          final VehicleState state =
            this.inferenceGraph.createVehicleState(
                ...
                pathStateDistribution, edgeTransDist, null);
