...
public abstract class AbstractVehicleStateFilter extends
    AbstractParticleFilter<GpsObservation, VehicleState>
    implements
    VehicleStateFilter<GpsObservation, VehicleState> {
  ...
  public AbstractVehicleStateFilter(GpsObservation obs,
