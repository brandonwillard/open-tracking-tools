...
public class CovarianceRoadTrackingEstimator
    extends
    AbstractRoadTrackingEstimator {

  private static final Logger log = LoggerFactory
      .getLogger(CovarianceRoadTrackingEstimator.class);
  ...
  public CovarianceRoadTrackingEstimator(
  ...
  @Override
  public CovarianceRoadTrackingEstimator clone() {
    final CovarianceRoadTrackingEstimator clone =
        (CovarianceRoadTrackingEstimator) super.clone();
    clone
  ...
  @Override
  public int compareTo(AbstractRoadTrackingEstimator o) {
    
    if (o instanceof CovarianceRoadTrackingEstimator) {
      
      final CovarianceRoadTrackingEstimator other =
          (CovarianceRoadTrackingEstimator) o;
  ...
  public boolean equals(Object obj) {
    ...
    final CovarianceRoadTrackingEstimator other =
        (CovarianceRoadTrackingEstimator) obj;
  ...
  private PathStateDistribution sampleFilteredTransition(
    PathStateDistribution prevStateSample1, Vector obs, Random rng) {

    final InferredPath path = prevStateSample1.getPath();
    final PathStateDistribution prior =
...
//                        .getDimensionality()))
  ...
  private PathStateDistribution sampleSmoothedPrevState(
    PathStateDistribution prior, PathStateDistribution priorPred,
    PathStateDistribution posterior, Vector obs, Random rng) {
    ...
    if (posterior.isOnRoad()) {
      ...
      F = AbstractRoadTrackingEstimator.getOr();
      ...
      y = obs;
      F = AbstractRoadTrackingEstimator.getOg();
