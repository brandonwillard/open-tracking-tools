...
public abstract class AbstractRoadTrackingEstimator
    extends AbstractCloneableSerializable implements
    Comparable<AbstractRoadTrackingEstimator> {

  protected AbstractRoadTrackingEstimator(
    GpsObservation obs,
  ...
  @Override
  public AbstractRoadTrackingEstimator clone() {
    final AbstractRoadTrackingEstimator clone =
        (AbstractRoadTrackingEstimator) super.clone();
   ...
   * @param edge
   */
  public PathStateDistribution measure(PathStateDistribution priorPathStateBelief,
  ...
  public PathStateDistribution predict(
    PathStateDistribution currentBelief, InferredPath path) {
    ...
    if (path.isNullPath()) {
       ...
       * Clamp to path
       */
      final double distance = AbstractRoadTrackingEstimator.getOr().times(
  ...
  public boolean equals(Object obj) {
    ...
    final AbstractRoadTrackingEstimator other =
        (AbstractRoadTrackingEstimator) obj;
    if (Qg == null) {
      if (other.Qg != null) {
        return false;
      }
  ...
  public abstract void update(VehicleState state,
    GpsObservation obs, PathStateDistribution updatedBelief,
