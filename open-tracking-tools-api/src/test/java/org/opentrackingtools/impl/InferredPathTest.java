...
public class InferredPathTest {
  ...
  public void testPrediction() throws TimeOrderException {
    ...
    final Observation obs =
        Observation.createObservation("none", new Date(
            System.currentTimeMillis()), new Coordinate(10,
            -5), 0d, 0d, 0d);

    final PathStateBelief belief =
        PathStateBelief.getPathStateBelief(newPath,
            startBelief);
