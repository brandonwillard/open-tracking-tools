...
public class UniquePathTest {
  ...
  public void testUnique() {
    ...
    final List<PathEdge> edges1 =
        new ArrayList<PathEdge>(Arrays.asList(PathEdge
            .getEdge(new InferredEdge(e1, 1, otpGraph), 0,
                false)));
    final InferredPath p1 =
        InferredPath.getInferredPath(edges1, false);
    paths.add(p1);
    ...
    final List<PathEdge> edges2 =
        Arrays.asList(PathEdge.getEdge(new InferredEdge(e2,
            2, otpGraph), 0, false));
    final InferredPath p2 =
        InferredPath.getInferredPath(edges2, false);
    paths.add(p2);
    ...
    final List<PathEdge> edges3 =
        Arrays.asList(PathEdge.getEdge(new InferredEdge(e2,
            2, otpGraph), 0, false), PathEdge.getEdge(
            new InferredEdge(e3, 3, otpGraph), 0, false));
    final InferredPath p3 =
        InferredPath.getInferredPath(edges3, false);
    paths.add(p3);
    ...
    final List<PathEdge> edges4 =
        Arrays.asList(PathEdge.getEdge(new InferredEdge(e2,
            2, otpGraph), 0, false), PathEdge.getEdge(
            new InferredEdge(e4, 4, otpGraph), 0, false));
    final InferredPath p4 =
        InferredPath.getInferredPath(edges4, false);
    paths.add(p4);

    final List<PathEdge> edges5 =
        Arrays.asList(PathEdge.getEdge(new InferredEdge(e2,
            2, otpGraph), 0, false), PathEdge.getEdge(
            new InferredEdge(e4, 4, otpGraph), 0, false),
            PathEdge.getEdge(new InferredEdge(e5, 5,
                otpGraph), 0, false));
    final InferredPath p5 =
        InferredPath.getInferredPath(edges5, false);
    paths.add(p5);
    OtpGraph.makeUnique(paths);
