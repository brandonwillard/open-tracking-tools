...
public class PathTest {
  ...
  public void setUp() throws Exception {
    ...
    this.vehicleStateInitialParams =
        new VehicleStateInitialParameters(null, VectorFactory
            ...
            VectorFactory.getDefault().createVector2D(0.000625,
                0.000625), 20, VectorFactory.getDefault()
                .createVector2D(5d, 95d), VectorFactory.getDefault()
                .createVector2D(95d, 5d), 25, 30, 0l);

    this.graph = Mockito.mock(InferenceGraph.class);
  }
  ...
  public void testBadConversion() {
    final Path startPath =
        TestUtils.makeTmpPath(this.graph, true, new Coordinate(20,
    ...
    final Path newPath =
        TestUtils.makeTmpPath(this.graph, true, new Coordinate(20,
            -10), new Coordinate(10, -10), new Coordinate(10, 0),
            new Coordinate(0, 0));
  ...
  public void testGetStateOnPath() {
    ...
    final Path startPath =
        TestUtils.makeTmpPath(this.graph, false,
    ...
    final Path newPath =
        TestUtils.makeTmpPath(this.graph, true,
  ...
  public void testPathEdge1() {
    final Path path1 =
        TestUtils.makeTmpPath(this.graph, false, new Coordinate(0,
            10.11d), new Coordinate(10.11d, 20d));

    final PathEdge edge1 =
        Iterables.getFirst(path1.getPathEdges(), null);

    final Vector testVec1 =
        VectorFactory.getDenseDefault().createVector2D(-1e-12d, -1d);
    ...
    final Vector testVec3 =
        VectorFactory.getDenseDefault().createVector2D(-1e-6d, -1d);
  ...
  public void testPathEdge1_2() {
    final Path path1 =
        TestUtils.makeTmpPath(this.graph, true,
            new Coordinate(0, 20d), new Coordinate(1d / 10d, 10.11d));
  ...
  public void testPathStateConvert1() {
    final Path startPath =
        TestUtils.makeTmpPath(this.graph, true, new Coordinate(0, 0),
            new Coordinate(10, 0));
  ...
  public void testPathStateConvert2() {
    ...
    AssertJUnit.assertEquals("distance", -0d, result.getMean()
        .getElement(0), 0d);
    AssertJUnit.assertEquals("velocity", -1d, result.getMean()
        .getElement(1), 0d);
  ...
  public void testPathStateConvert3() {
    ...
    AssertJUnit.assertEquals("distance", 2.5d, result.getMean()
        .getElement(0), 0d);
    AssertJUnit.assertEquals("velocity", 1d, result.getMean()
        .getElement(1), 0d);
  ...
  public void testPathStateConvert5() {
    ...
    AssertJUnit.assertEquals("distance", 7.5d, result.getMean()
        .getElement(0), 0d);
    AssertJUnit.assertEquals("velocity", -1d, result.getMean()
        .getElement(1), 0d);
