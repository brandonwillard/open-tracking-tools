...
public class CountedDataDistributionTest {
  ...
  public void testCountedDataDistributionLogScale() {
    ...
    AssertJUnit.assertEquals(Math.log(10d), testDist.get("item1"),
        1e-2);
    AssertJUnit.assertEquals(Math.log(100d), testDist.getTotal(),
        1e-2);
    AssertJUnit.assertEquals(-Math.log(10d),
        testDist.getLogFraction("item1"), 1e-2);
    AssertJUnit.assertEquals(1d / 10d, testDist.getFraction("item1"),
        1e-2);
    AssertJUnit.assertEquals(testDist.getFraction("item1"),
    ...
    AssertJUnit.assertEquals(Math.log(100d), testDist.getTotal(),
        1e-2);
    AssertJUnit.assertEquals(Math.log(2d) - Math.log(10d),
        testDist.getLogFraction("item1"), 1e-2);
    AssertJUnit.assertEquals(2d / 10d, testDist.getFraction("item1"),
        1e-2);
    AssertJUnit.assertEquals(testDist.getFraction("item1"),
        Math.exp(testDist.getLogFraction("item1")), 1e-2);
    ...
    AssertJUnit.assertEquals(testDist.getDomainSize(),
        testDistClone.getDomainSize());
    AssertJUnit.assertEquals(testDist.getTotal(),
        testDistClone.getTotal());
    AssertJUnit.assertEquals(testDist.getTotalCount(),
        testDistClone.getTotalCount());
    AssertJUnit.assertEquals(testDist.getLogFraction("item1"),
        testDistClone.getLogFraction("item1"));
    AssertJUnit.assertEquals(testDist.getLogFraction("item2"),
        testDistClone.getLogFraction("item2"));
    AssertJUnit.assertEquals(testDist.getLogFraction("item3"),
        testDistClone.getLogFraction("item3"));
    AssertJUnit.assertEquals(testDist.getLogFraction("item4"),
        testDistClone.getLogFraction("item4"));
    AssertJUnit.assertEquals(testDist.getCount("item1"),
        testDistClone.getCount("item1"));
    AssertJUnit.assertEquals(testDist.getCount("item2"),
        testDistClone.getCount("item2"));
    AssertJUnit.assertEquals(testDist.getCount("item3"),
        testDistClone.getCount("item3"));
    AssertJUnit.assertEquals(testDist.getCount("item4"),
        testDistClone.getCount("item4"));

    testDist.increment("item1", Math.log(10));
    AssertJUnit.assertEquals(9, testDist.getTotalCount());
    AssertJUnit.assertEquals(Math.log(110d), testDist.getTotal(),
        1e-2);

    testDist.increment("item1", Math.log(10), 2);
    AssertJUnit.assertEquals(11, testDist.getTotalCount());
    AssertJUnit.assertEquals(Math.log(120d), testDist.getTotal(),
        1e-2);
    ...
    AssertJUnit.assertEquals(numSamples,
