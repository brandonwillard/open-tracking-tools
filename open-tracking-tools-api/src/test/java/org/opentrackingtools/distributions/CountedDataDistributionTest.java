...
public class CountedDataDistributionTest {
  ...
  public void testCountedDataDistributionLogScale() {
    CountedDataDistribution<String> testDist = new CountedDataDistribution<String>(true);
    ...
    CountedDataDistribution<String> testDistClone = testDist.clone();
...
//    AssertJUnit.assertEquals(Math.log(100d), testDist.getTotal(), 1e-2);
    ...
    CountedDataDistribution<String> sampleDist = new CountedDataDistribution<String>(true);
...
//         Math.sqrt(testDist.getFraction("item4") * (1d - testDist.getFraction("item4"))));
    ...
    CountedDataDistribution<String> sampleDist2 = new CountedDataDistribution<String>(true);
