...
public class InferenceInstance {
  ...
  private static OtpGraph inferredGraph = Application.getGraph();
  ...
  public InferenceInstance(String vehicleId,
    ...
    this.filterType = VehicleTrackingPLFilter.class;
  }
  ...
  private boolean shouldProcessUpdate(Observation obs) {
    ...
    if (!isEnabled || InferenceStore.getInferenceInstance(vehicleId) == null)
      return false;
