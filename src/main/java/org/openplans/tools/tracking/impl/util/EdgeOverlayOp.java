 ...
 */
  ...
  {
    EdgeOverlayOp gov = new EdgeOverlayOp(geom0, geom1);
...
//nodeMap.print(System.out);
    ...
    EdgeLineBuilder lineBuilder = new EdgeLineBuilder(this, geomFact, ptLocator);
    resultLineList = lineBuilder.build(opCode);

    EdgePointBuilder pointBuilder = new EdgePointBuilder(this, geomFact, ptLocator);
