...
public class EdgeLineBuilder {
  ...
  public EdgeLineBuilder(EdgeOverlayOp op, GeometryFactory geometryFactory, PointLocator ptLocator) {
    this.op = op;
...
//node.print(System.out);
  ...
  private void collectLineEdge(DirectedEdge de, int opCode, List edges)
  {
    ...
    if (de.isLineEdge()) {
      if (! de.isVisited() && EdgeOverlayOp.isResultOfOp(label, opCode) && ! e.isCovered()) {
