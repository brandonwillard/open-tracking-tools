...
public class LinearTurnTrackingFilter extends AbstractKalmanFilter {
  ...
  private static final long serialVersionUID = 8740614889469304458L;
  ...
  public LinearTurnTrackingFilter(double initialTurnRate,
    double gVariance, double aVariance) {

    super(VectorFactory.getDefault().createVector(5),
        createStateCovarianceMatrix(1d, aVariance), MatrixFactory
            .getDefault().createIdentity(2, 2).scale(gVariance));
